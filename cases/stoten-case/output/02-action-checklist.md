# Louise Stoten Case - Action Checklist

**Deadline:** ~8 February 2026 (7 days from 1 Feb)
**Confidentiality:** Keep strictly below the radar
...
- [ ] **Obtain Maria Tam's prescription records**
  - Steroid prescriptions (exact dosing)
  - Antibiotic prescriptions (Augmentin, Azithromycin)
...
- [ ] **Engage senior counsel**
  - Route through Yes to Life
  - *After briefing Wendy*

- [ ] **Respond to Paul Stoten**
  - *By ~8 February 2026*
...
- [ ] **Verify CQC license dates**
  - Confirm license status for July-August 2025
  - *Note: Primary defense doesn't rely on this (naturopath role)*

- [ ] **Check for additional referral letters**
  - Any correspondence not yet collected

---

## Completed

- [x] Invoice collection (43 total: 8 London + 35 Cape Town)
- [x] Prof. Stebbing letters collected (July 10, 2025)
- [x] Referral to Dr. de Andrade collected (Sept 15, 2025)
- [x] Medicolegal defense documents prepared
- [x] Executive summary prepared

---

## Staff to Contact (Confidentially)

| Person | Request | Status |
|--------|---------|--------|
| **Maria Tam** | Prescription records | Pending |
...
| Date | Event |
|------|-------|
| 1 Feb 2026 | Complaint received |
| ~3 Feb 2026 | Brief Wendy (Monday) |
| ~8 Feb 2026 | **DEADLINE - Respond to Paul Stoten** |

---

*Print this checklist and update as items are completed.*
