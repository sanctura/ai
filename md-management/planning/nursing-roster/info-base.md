...
**Problem**: Both clinics (Cape Town and London) lack a formalised, documented nursing and reception roster with clear shift structures, Saturday on-call coverage, and governance documentation.

**Success Criteria**:
- [ ] Nursing roster agreed and published for Cape Town (4 nurses)
- [ ] Nursing roster adapted and agreed for London (3 nurses + locum)
- [ ] Reception weekly roster confirmed for both clinics
- [ ] Saturday on-call phone model operational at both clinics
- [ ] CQC-aligned SOP for reception/on-call adopted in London
- [ ] Staff briefed and roster live
- [ ] On-call compensation structure defined

**Strategic Alignment**: Operational excellence — clinical staffing governance, CQC compliance (UK), and patient safety.
...
|------|----------|-----------|---------|
| 2026-03-07 | Use James's 4-week rotating anchor model as the base for Cape Town nursing roster | CEO proposal; structurally sound for 4-nurse team | Pending confirmation |
| 2026-03-07 | UK roster requires adaptation from 4-nurse to 3-nurse + locum model | UK clinic headcount differs from Cape Town | Pending |
...
- Which nurse names map to Nurse A/B/C/D slots in each clinic
- Who owns ongoing roster management week-to-week (Practice Managers)
...
## 5. Stakeholders & Adoption

| Stakeholder | Role | Adoption Status |
|-------------|------|-----------------|
...
| Reception staff (both clinics) | Reception roster and SOP end users | Not yet briefed |

**Friction Points**:
- UK roster requires adaptation (3 nurses vs 4-nurse model) — locum integration unresolved
- On-call compensation not yet defined — will affect staff buy-in
- CQC compliance adds governance overhead for London; SOP must be formally adopted
...
- [ ] Grant: Define on-call compensation structure for anchor nurses
- [ ] Amanda/Kyle: Arrange phone diversion setup for Saturday on-call model
- [ ] Amanda/Kyle: Brief all nursing and reception staff once roster is confirmed
...
- Phone auto-divert with 2-step failover (primary nurse → standby nurse → voicemail) — low-tech, low-cost
- Evening protected time built into nursing roster for protocol study and mandatory end-of-month protocol test — good for compliance and development
- CQC SOP alignment for London — positions Sanctura well for CQC inspection

---

## 8. Patterns & Lessons Learned

**What's Working**: CEO has produced well-structured, implementation-ready proposals — minimal rework needed to operationalise.

**What's Not**: Initiative has stalled at Grant's level due to sequencing with other changes. CEO has been waiting. Risk of further delay if London visit window is missed.

**Adjustments Made**: None yet — first review of proposals.

**Watch**: This initiative has an impatient sponsor (CEO). Grant has committed to the London visit window as the rollout moment. Missing that milestone will require a direct conversation with James.
