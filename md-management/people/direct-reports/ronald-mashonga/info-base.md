...
**Overall Rating**: New — insufficient data to rate
**Trajectory**: New
**Last Formal Review**: —
...
|------|--------|-------|----------|-------------|
| 2026-02-04 | Ricardo Delgado (Capricorn Capital) | Preferred over Keith; described as "much more on the pulse" and capable of doing the job better | Positive | Offer made |
| 2026-02-04 | Dr James Laporta (CEO) | Emphasised urgency of filling role to stabilise clinics; asked directly if Ronald was willing to do hands-on FM work | Positive/Testing | Ronald confirmed willingness |
...
- CA(SA) with 15+ years financial leadership; deep multi-entity consolidation experience
- Proven business rescue and turnaround capability (SAA group, listed company environments)
- Strong communicator at board and operational levels
- Capital raising experience (>$10m in recent Zambia engagement)
- Technology-adaptable; experienced with cloud/async working

**Growth Areas**:
- Healthcare sector is new — will need to ramp on BHF, HPCSA, and clinical invoicing nuances
- Managing a primarily remote/fractional engagement in a relationship-heavy environment

**Skill Development Timeline**:
| Date | Milestone |
|------|-----------|
| 2026-02-23 | Complete handover from Alida Wiese |
| 2026-03-10 | Month 1 review — assess healthcare finance ramp-up |
...
- Weekly check-in attendance and quality of updates
- ~~Bookkeeper hired by end of Feb/early March~~ — Done (24 Feb)
- Cash flow forecast produced by end of March
- Management accounts delivered by 7th working day of each month
- Any instance of external contact made without Grant's approval
...
|------|----------|-----------|---------|
| 2026-02-04 | Ronald Mushonga selected as preferred candidate over Keith | Ricardo Delgado and panel assessed Ronald as more engaged and capable; "much more on the pulse" | Offer extended; contract signed 9 Feb 2026 |
| 2026-02-09 | Contract signed for 4 months (not 6 as Ronald preferred) | Cost and timeline constraints; provision for extension by mutual written agreement | Contract period: 9 Feb – 9 Jun 2026 |
| 2026-02-09 | Ronald operates without payment/banking access | Control measure — Consultant has no ability to load or release payments | Grant loads; Grant/Yaseen release non-SARS; James releases SARS |

### Context for Future Reference
- Ronald operates through his entity **Clearshell Management Solutions (Pty) Ltd** — not an individual employee. All invoices come from Clearshell; VAT is Ronald's responsibility.
- There is an **agency involved in this placement** (~12% monthly commission on top of the R115k rate). Total cost of engagement needs to be confirmed and tracked.
- February invoice must be **prorated** for actual days worked (started 9 Feb).
- Invoice submitted to: grantm@sanctura.co.uk AND accounts@drjameslaportainclife.com
- Ronald's preferred arrangement was 6 months; Grant and Ricardo settled on 4 months. Ronald may raise extension discussion at the mid-contract review (~10 April).
- Ricardo Delgado (Capricorn Capital) is an active stakeholder who participated in the interview and has ongoing interest in this appointment. He reviews the annual forecast.
- The previous Financial Manager (Alida Wiese) struggled with the transition from single-clinic to multi-entity group accounting — Ronald is explicitly being brought in to fix that.
- **UK matters**: UK supplier matters route through Amanda Ross (Practice Manager, London).
- Ronald must NOT contact external service providers without Grant's prior written approval. This is a hard contract requirement (Clause 15) and a separately agreed operating rule.
- Ronald is based in **Johannesburg** and travels to Cape Town. The exact travel arrangement was not formally resolved in the contract documents reviewed.
...
**Direct Reports**: Lebogang Nkopodi (Bookkeeper/Processor — permanent, started 2026-02-24)
**Key Stakeholders**:
- Dr James Laporta (CEO) — payment release for SARS; clinic stabilisation sponsor
- Ricardo Delgado (Capricorn Capital) — board-level stakeholder; reviews annual forecast; co-led the interview
- Alida Wiese — outgoing Finance Manager; handover partner (overlap: 9–23 Feb 2026)
- Yaseen Harneker — payment release (non-SARS, alongside Grant)
- Kyle Bennett — stock count coordination; debt escalation (Cape Town)
- Amanda Ross — UK supplier matter escalation; debt escalation (London)
- Inaura — current SA payroll/accounting provider (to be transitioned)
- Kinari / Capricorn Capital Services — UK payroll/accounting provider
- Bokelman — potential replacement for Inaura (transition target)

**Collaboration Quality**:
- With peers: Insufficient data
- With clinical staff: Insufficient data
- Cross-location: Insufficient data
...
| CV | `documents/Ronald.Mashonga-CV.pdf` |
| Interview Notes | `documents/Ronald.Mashonga-interview-notes-2026-02-04.md` |
