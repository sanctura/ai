...
### 2026-02-10 `[feedback-received]`
CEO feedback (relayed via Grant): Frustrated by recurring forgetfulness on assigned tasks — Amanda has been tasked with various activities over time that she keeps forgetting, responding with an "oopsie" reaction when reminded. Multiple operational items not attended to: deliveries mismanaged (Elena's package, Grant's Christmas gift found a month later), Polycom in private patient suite signed in with personal account, fridge not stocked, expensive hyperthermia equipment improperly stored on crystals in pharmacy, crystals not placed around office as requested, incense stored in pharmacy, display window lacking stock, stock samples with stickers not removed, travel bags in pharmacy instead of storage, HBOT room needs extraction fan, decorative rocks not lit up as requested, charging chair in private suite not set up. CEO expects practice manager to work the floor daily with a checklist, inspecting rooms and building a snag list. CEO is frustrated by lack of attention but acknowledges Amanda's commitment, effort, and long hours. Willing to support Grant's process of setting clear expectations. *(Source: James feedback)*

### 2026-02-10 `[observation]`
Handover from Yaseen (batch 1) — open items Amanda is managing: Maria Vega employment contract (draft ready, Amanda to close off; Maria V recently started 3 days/week, exploring more full-time arrangement; also exploring room rental at 20% discount on 60 GBP/hr), Maria Tam periodic review (6-monthly check on private practice arrangement — Amanda may have had the conversation recently), CQC policy review (in progress, annual requirement, policies initially drawn up by Amanda and reviewed by external expert), plant wall installation (closing off with Plant Care), Lexee salary request (started 07 July 2025, no prior experience, feedback is she has excelled — consider at annual increase). *(Source: Yaseen handover email)*

### 2026-02-10 `[observation]`
Handover from Yaseen (batch 2) — facilities items: lift shaft cleaning (done, check if repaint needed), HBOT signage (up but needs images/graphics), UK breathwork room conversion to immersive sensory room (in progress, unclear instructions, Amanda adding/removing as requests come in, items still outstanding), shelving for store room and studio (to be ordered, previous payment issues), glass board for consulting room (procuring alternative — previous board too heavy for drywall), water dispenser for waiting room (sourcing, challenges with aesthetics/plumbing/functionality), ventilation/cooling for HBOT room and pharmacy store (costly solution, needs landlord approval, long lead times, specialist contractor drawings required), daily walkthrough checklist (implemented and updated by Amanda). *(Source: Yaseen handover email)*
