...
- Chemo application: pre-application – appointment secured with architect,
previous submissions and regulations reviewed, emailed DoH, requested
appointment with pharmaceutical company, plans requested – some received,
...
what information will be required – strategy and sources to be identified
- Complete referral fee agreement with Dr Hari
**Anything you need from me?**
- Consider when developing how we can automatically draw number of patients
on chemo and transferred out for chemo for chemo application
