...
- **Reports To**: Grant Merwitz (MD)
- **Start Date**: Position open
- **Location**: [To be determined]
- **Key Responsibilities**: [To be defined]
- **Performance Status**: N/A - Vacant Position
- **Current Focus**: N/A
- **Notes**: Currently has 4 staff reporting to this role (Consultant, Practice Manager, 2 Receptionists) - interim management needed
...
2. **Amanda Ross** - Practice Manager - [To be assessed]
...
- [Name] - [Why they're critical] - [Risk if lost] - [Succession plan]

**High Performers to Retain**:
- [Name] - [Their impact] - [Retention strategy]

**Development Investments**:
- [Name] - [Development area] - [Expected timeline]
...
- **Morale**: [High/Medium/Low] - [Notes]
- **Turnover Risk**: [Low/Medium/High] - [Who/Why]
- **Capacity**: [Under/Right/Over] - [Details]
- **Skill Gaps**: [List critical gaps]
